...
/// Custom plugins
// import Pill from "./pill/src/pill.js";
import Pill from "./abbreviation/abbreviation";
...
Editor.defaultConfig = {
  placeholder:
    "Enter any text here for your document. Use the “Pill” button for text you want Moxie to speak.",
  htmlSupport: {
    allow: [
      {
        name: /.*/,
